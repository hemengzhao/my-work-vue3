<template>
  <div>
    <div class="content">
      ...
      尔来四万八千岁，不与秦塞通人烟。 西当太白有鸟道，可以横绝峨嵋巅。
...
import Img from '@/assets/case/1.webp'
const cunts = ref<number>()
</script>
...
img {
  ...
  /* shape-outside: ellipse(70% 20% at 50% 50%); */
}

/* .dom2 {
  border-radius: 50%;
  height: 100px;
  shape-outside: ellipse(70% 60% at 10% 10%);
} */
</style>
